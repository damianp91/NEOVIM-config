  ...
  config = function()
    require('toggleterm').setup({
      ...
      float_opts = {
        ...
        width = function() return math.floor(vim.o.columns * 0.7) end,  -- 70% weight
        height = function() return math.floor(vim.o.lines * 0.7) end,   -- 70% height
        winblend = 10,            -- Tranparency (0-100)
      },
